...
#' @param params$exp_growth_rate (Numeric) The exponential growth rate (r) that happens prior to reaching the canopy closure threshold
#' @param params$lin_growth_rate (Numeric) The linear growth rate (g) that happens after a forest reaches the canopy closure threshold
